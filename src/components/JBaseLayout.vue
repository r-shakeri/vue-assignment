...
header {
    ...
    border-bottom: 2px solid #C59B8A;
    height: 300px;
    display: flex;
    align-items: center;
    padding: 0 0 64px 0;
    .header-container {
      ...
      @include media-breakpoint-handset() {
        .logo {
          max-width: 300px;
        }
        .description {
